...
var Descriptions = {
  ...
  cubonic:
    "Cubonic: Original logic puzzle app with full CRUD functionality. As of writing this, only one person (barring myself) has managed to solve all 10 levels. (Ruby on Rails, JQuery animations, postreSQL)",
